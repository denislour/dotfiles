...
let
  ...
  settingsJSON = jsonFormat.generate "zed-settings" {
    ...
    agent = {
      ...
      tool_permissions = {
        ...
        tools = {
          ...
          "mcp:mcp-server-brave-search:brave_web_search".default = "allow";
          "mcp:mcp-server-brave-search:brave_local_search".default = "allow";
        };
      };
    };
    ...
    lsp.nil = {
      ...
      initialization_options.formatting.command = [ "${pkgs.alejandra}/bin/alejandra" "-q" ];
    };
  };
