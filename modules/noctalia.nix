...
in
{
  ...
  let
    wallpaperDir = "/home/${config.home.homeDirectory}/.local/share/noctalia/wallpapers";
    wallpaperPath = "${wallpaperDir}/default.jpg";
  in
  {
    ...
    programs.noctalia-shell = {
      ...
      settings = {
        ...
        general = {
          avatarImage = "/home/${config.home.homeDirectory}/.face";
          radiusRatio = 2;
        };
