{
  programs.starship = {
    ...
    settings = {
      format = "[](bg:base08 fg:base00)$os$username[](bg:base09 fg:base08)$directory[](bg:base0A fg:base09)$git_branch$git_status[](bg:base0B fg:base0A)$nix_shell[](fg:base0B)$line_break$character";
